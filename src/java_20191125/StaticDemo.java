...
public class StaticDemo {
	...
	public void m1(){
		StaticDemo.name = "sung";//인스턴스 메서드에서는 static 변수 사용 가능
		this.age = 10;//인스턴스 메서드에서는 인스턴스 변수 사용 가능
		this.m2();//인스턴스 메서드에서는 인스턴스 메서드 호출 가능
		StaticDemo.m4();///인스턴스 메서드에서는 static 메서드 호출 가능
	}
	public void m2(){
